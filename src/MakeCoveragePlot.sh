...
echo "/home/pi/koslickd/./snap-aligner single ${dataDir} ${metagenome} -F a -hp -mrl 40 -xf 1.2 -d 40 -o -sam ${dataDir}${metagenomeBasename}.21.jf-aligned.sam > ${dataDir}${metagenomeBasename}.21.jf-alignment-stats.txt"
